...
int main(void)
{
	...
	//	localNumDCs--;
		...
		msList->dc[localNumDCs].lastTimeHeardFrom.time = 0;
			...
			sprintf(strProcessID, "%d", msList->dc[localNumDCs].dcProcessID);//NEW ADDED LINE
		...
		else if (rc >= 0)//NEW ELSE
		{
			...
			msList->dc[cur_dc_id].lastTimeHeardFrom.time = 0;
